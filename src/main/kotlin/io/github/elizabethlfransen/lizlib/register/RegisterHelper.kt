...
class RegisterHelper(
    ...
    private val registerFactory: IDeferredRegisterFactory,
    private val registerProviders: Map<Class<*>, RegisterProvider<*>>
) {
     ...
     */
    inline fun <reified T> resolveRegister() = resolveRegister(T::class.java)
